...
<div class="portfolio-single container clearfix">
  ...
  <div class="buttons-devices">
    ...
    <button type="button" class="btn btn-device active" id="mbp-toggle">
      <img src="<?php bloginfo('template_path'); ?>/img/svg/device-01.svg" class="desktop">
      <h5>desktop</h5>
    </button>
    <button type="button" class="btn btn-device" id="ipad-toggle">
      <img src="<?php bloginfo('template_path'); ?>/img/svg/device-02.svg" class="tablet">
      <h5>tablet</h5>
    </button>
    <button type="button" class="btn btn-device" id="iphone-toggle">
      <img src="<?php bloginfo('template_path'); ?>/img/svg/device-03.svg" class="mobile">
      <h5>mobile</h5>
    </button>
  </div>
